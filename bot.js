...
function respond() {
  ...
  var gals = ['Abbie Spector', 'Abigail Schneider', 'Alexandra Bacchus', 'Amanda Halacy', 'Becca Groner', 'Briana Natalie', 'Bridget Lanigan', 'Brooke Sterneck', 'Catherine Levins', 'Corinne Sullivan', 'Courtney Morgan', 'Danya B', 'Dawn musil', 'Ella Simmons', 'Grettie Mason', 'Ibanca Anand', 'Jeannie blackwood', 'Jordan Symone', 'Julia Wang', 'Kate Connors', 'Kelly Ready', 'Kelsey Murphy', 'Kimmi Schonhorst', 'Liv Sisson', 'Liv Stromme', 'Liz Treacy', 'Lydia Ottaviano', 'Mady Jankowski', 'Mallory Michaelis', 'Martha Cosgrove', 'Michelle Khalid', 'Paola Peraza', 'Perrin Brown', 'Rachel Smedley', 'Sally Lindsay', 'Sarena Martinez'];
  var guys = [ 'Aaron McClendon', 'Adam Rukin', 'Aleck Pinto', 'Alex Gaggino', 'Arjun Nukal', 'B O\'B', 'Beans', 'Brandon Davenport', 'David Yocum', 'Dayo Akinjisola', 'Drew Carlson', 'Eli Panken', 'Evan Matuszak', 'Gene Wiliams', 'Guyrandy Jean-Gilles', 'Jaafar Mothafer', 'James Dolgin', 'James Levine', 'Jeff Biestek', 'Joe Sullivan', 'Jon Weiss', 'Josh Harrison', 'Joshua Su', 'Justin Ramos', 'Katie Connors', 'Matt Bee', 'Matt Crescinmanno', 'Micah Jaffe', 'Micah Leinbach', 'Miguel Ramirez', 'Mihir Pershad', 'Nick Zajciw', 'Noah Zweben', 'Petey DeJoy', 'Rahul Narain', 'Ryan Cleary', 'Sam Einhorna', 'Sam Koening', 'Sam Summer', 'Saseen Najjar', 'Sean McCroskey', 'Spencer Keith', 'Steven Soto', 'Thomas Krumins', 'Vinay Nagaraj', 'Zac Levin'];
